...
function unbeatable_reason() {
  return (
    <div className='unbeatable-main bg-backgrounds-lightGreenBlue'>
      <h1 className='text-center'><span className='highlight-green'>5 Unbeatable Reasons</span> To Get An MBA In 2023</h1>
    ...
    <div className="unbeatable-inner-container">
        <div className='unbeatable-inner-flex'>
            <img src="\images\svg\unbeatable1-icon.svg" alt="" />
        ...
        <div className='unbeatable-inner-flex'>
            <img src="\images\svg\unbeatable2-icon.svg" alt="" />
            <div className='unbeatable-inner-flex-content'>
        ...
        <div className='unbeatable-inner-flex'>
            <img src="\images\svg\unbeatable3-icon.svg" alt="" />
            <div className='unbeatable-inner-flex-content'>
        ...
        <div className='unbeatable-inner-flex'>
            <img src="\images\svg\unbeatable4-icon.svg" alt="" />
            <div className='unbeatable-inner-flex-content'>
        ...
        <div className='unbeatable-inner-flex'>
            <img src="\images\svg\unbeatable5-icon.svg" alt="" />
            <div className='unbeatable-inner-flex-content'>
