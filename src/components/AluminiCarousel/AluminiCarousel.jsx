  ...
  return (
    <div className="alumini-carousel-main">
      <h1 className="">
        ...
        <span className="highlight-green">Our</span>
        <span className="text-[#259D4A]"> Alumni</span>
        <span className="text-[#259D4A]">&nbsp;Thrive </span>
      </h1>
      <div className="alumini-carousel-cards m-auto">
        <Marquee direction="right" speed={100}>
          <div className="alumini-carousel-cards-1 ">
            ...
            <img
              className="alumini-carousel-card "
              src={mashreeq}
              alt="mashreeq"
            />
            <img
            ...
            <img
              className="alumini-carousel-card "
              src={standard_chartered}
              alt="standard_chartered"
            />
            <img
              className="alumini-carousel-card "
              src={emirates}
