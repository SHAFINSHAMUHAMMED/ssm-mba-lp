    ...
    <div className="uae-professional-main">
      <div className="uae-professional-inner">
        <div className=" uae-professional-inner-1">
          <h1>
            How <span className="highlight-green">UAE</span>{" "}
            <span className="text-[#259D4A]">Professionals</span> are&nbsp;
            <span className="wavy-underline-green">Rising</span>
            <span className="wavy-underline-green2"> to </span>
            <span className="wavy-underline-green2">the Top</span>—And the
            Pathway for You to Join Them!
          </h1>
          <img
        ...
        <img className=" uae-professionals-img-2" src={professionals2} alt="" />
      </div>
      {/* </div> */}
    </div>
  );
